...
harpoon:setup({})
--
-- -- this is my old config which only allows entries to be added using the telescope but not able to delete.
...
vim.keymap.set("n", "<C-s>", function() harpoon.lists.select(4) end)
